...
import Card1 from './images/credit-card-1.png';
import Card2 from './images/credit-card-2.png';
      ...
      <Header/>
        ...
        <div className="profile-container">
          ...
          <div class="content">
            ...
            <div class="row mt-5">
                <div class="col-lg-6"><img src={Card1} alt=""/></div>
                <div class="col-lg-6"><img src={Card2} alt=""/></div>
            </div>
        </div> 
        </div>     
 <Footer/>
