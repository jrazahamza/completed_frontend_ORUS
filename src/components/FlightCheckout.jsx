...
import Image1 from '../Images/emirate.png';
import Image2 from '../Images/cvk-bulding-icon.png';
          ...
          <Col md={4}>
            <Card>
              <Card.Body>
                ...
                <img src={Image1} alt="Invoice" className="m-5" />
